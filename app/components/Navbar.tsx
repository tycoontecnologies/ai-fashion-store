...
const [mega,setMega] =
    useState<"men"|"accessories"|null>(null);

const [megaTimer,setMegaTimer] =
    useState<NodeJS.Timeout | null>(null);


const openMega = (
menu:"men"|"accessories"
)=>{
    if(megaTimer){
...
<MegaMenu
type="accessories"
show={mega==="accessories"}
onEnter={()=>openMega("accessories")}
onLeave={closeMega}
/>
