    ...
    <>
      ...
      >
        <div className="mx-auto flex h-20 max-w-[1440px] items-center px-6">
          ...
          <nav
            className="ml-12 hidden lg:flex items-center gap-8 text-[13px] font-semibold tracking-[0.18em]"
          ...
          >
            ...
            />
            <span className="text-2xl font-semibold tracking-[0.18em]" style={{ color: "#111111" }}>
              Guess360
            </span>
          </Link>

          <div className="ml-auto flex items-center gap-5 text-black">
